...
namespace Ch04RealWorldScenario01
{
    public partial class Form1 : Form
    {
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            else extendedPrice1TextBox.Text = extendedPrice.ToString("C");
            ...
            else extendedPrice2TextBox.Text = extendedPrice.ToString("C");
            subtotal += extendedPrice;
            ...
            else extendedPrice3TextBox.Text = extendedPrice.ToString("C");
            subtotal += extendedPrice;
            ...
            else extendedPrice4TextBox.Text = extendedPrice.ToString("C");
            subtotal += extendedPrice;
